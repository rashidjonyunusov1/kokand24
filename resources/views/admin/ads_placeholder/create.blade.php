        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <form class="create__inputs" action="{{ route('admin.ads_placeholder.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <strong> title :</strong>
                        <input type="text" name="ads_placeholder" class="form-control"> <br>
