                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{ route('admin.ads_placeholder.index')}}" class="dropdown-item">ads placeholder</a>
                            <a href="{{ route('admin.app_download.index')}}" class="dropdown-item">app download</a>
